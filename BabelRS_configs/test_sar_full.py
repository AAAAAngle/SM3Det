...
sar_train_dataset = dict(
    ...
    ann_file=
    '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/SARDet_50K/Annotations/after_merge_train.json',
    img_prefix=
    '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/SARDet_50K/JPEGImages/',
    pipeline=[
        dict(type='LoadImageFromFile'),
        dict(type='LoadAnnotations', with_bbox=True),
        dict(type='Resize', img_scale=(800, 800), keep_ratio=True),
...
rgb_train_dataset = dict(
    ...
    ann_file=
    '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DOTA_800pix/train/annfiles/',
    img_prefix=
    '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DOTA_800pix/train/images/',
...
ifred_train_dataset = dict(
    type='SARDetDotaIFRedDataset',
    ann_file=
    '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DroneVehicle/dota_train/annfiles/',
    img_prefix=
    '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DroneVehicle/dota_train/png_images/',
...
data = dict(
    ...
    val=dict(
        type='SARDet_hbb_trisource',
        ann_file=
        '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/SARDet_50K/Annotations/after_merge_test.json',
        img_prefix=
        '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/SARDet_50K/JPEGImages/',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    val_2=dict(
        type='SARDetDotaIFRedDataset',
        ann_file=
        '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DOTA_800pix/val/annfiles/',
        img_prefix=
        '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DOTA_800pix/val/images/',
    ...
    val_3=dict(
        type='SARDetDotaIFRedDataset',
        ann_file=
        '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DroneVehicle/dota_test/annfiles/',
        img_prefix=
        '/mnt/data/jfu/workspace/SM3Det-main/data/SOI_Det/DroneVehicle/dota_test/png_images/',
...
lr_config = dict(
    ...
    step=[29752, 40909])
runner = dict(type='IterBasedRunner', max_iters=44628)
checkpoint_config = dict(interval=3719)
...
model = dict(
    ...
    backbone=dict(
        ...
        pretrained=
        '/mnt/data/jfu/workspace/SM3Det-main/data/pretrained/BabelRS_ViT-300M.safetensors',
...
gpus = 6
batch_size = 4
evaluation2 = dict(interval=14876, metric='mAP')
evaluation3 = dict(interval=14876, metric='mAP')
